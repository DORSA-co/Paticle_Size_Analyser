...
"")
        ...
        self.verticalLayout.addWidget(self.converting_progressbar)
...
"}")
    ...
    def retranslateUi(self, rebuild_win):
        ...
        self.close_btn.setText(QCoreApplication.translate("rebuild_win", u"Close", None))
    # retranslateUi
